...
<section class="main-container">
	<div class="main-wrapper">
		...
		<div id="example1">
			...
			<h2>Register</h2>
			<form class="signup-form" action="includes/signupstable.inc.php" method="POST">
				<input type="text" name="first" placeholder="First Name" required pattern="^([a-zA-Z]+$)" title="Please input only characters from A-Z.">
				<input type="text" name="last" placeholder="Last Name" required pattern="^([a-zA-Z]+$)" title="Please input only characters from A-Z.">
